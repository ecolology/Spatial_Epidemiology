...
#containing all the covariates presented in the paper "Model building and 
#assessment of the impact of covariates for disease prevalence mapping in 
#low-resource settings: to explain and to predict."

#Source: https://github.com/giorgilancs/covariates/
...
setwd("C:/Users/uqbsarto/Downloads/")

##Part 1: exploring relationships between covariates and prevalence; testing for residual spatial correlation.
